import { CoreMessage, CoreUserMessage, CoreToolMessage, CoreSystemMessage, CoreAssistantMessage, ToolResultPart } from 'ai'
import {
    SystemMessage,
    BaseMessage,
    HumanMessage,
 ...
 */
export const convertToLangchainBaseMessage = (message: CoreMessage): BaseMessage => {
